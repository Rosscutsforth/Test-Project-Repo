...
class playGame extends Phaser.Scene{
    ...
    preload(){
        this.load.spritesheet('gems', 'Assets/Hexagons.png', {
            frameWidth: gameOptions.gemSize,
            frameHeight: gameOptions.gemSize
        })
        this.load.image('arrows', 'Assets/CircleSmol.png')
    }
    create(){
        this.canPick = true;
        this.dragging = false;
    ...
    drawField(){
        ...
        for(let i = 0; i < this.draw3.getRows(); i ++){
            ...
            for(let j = 0; j < this.draw3.getColumns(); j ++){
                var posX = gameOptions.boardOffset.x + gameOptions.gemSize * j + gameOptions.gemSize / 2;
    ...
    gemSelect(pointer){
        if(this.canPick){
            ...
            if(this.draw3.validPick(row, col)){
                ...
                this.draw3.customDataOf(row, col).alpha = 0.75;
                this.dragging = true;
            }
        }
    }
