...
class playGame extends Phaser.Scene{
    ...
    preload(){
        this.load.atlas("gems", "assets/Hexagon_Spritesheet_Small.png", 'assets/Hexagon_Spritesheet_Small.json', {
...
//Resizes the window if window ratio is smaller than game ratio
function resize() {
